...
d3.json("/north_port").then(files => {
  // file will contain north_port api route

  var northPort = d3.map(files, d => { return (d.PortName) }).keys()
  ...
  function update(selectedGroup) {
    ...
    var dataFilter = files.filter(function (d) { return d.PortName == selectedGroup })
